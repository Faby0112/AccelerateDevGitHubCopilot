...
public class ConsoleApp
{
    ...
    public ConsoleApp(ILoanService loanService, IPatronService patronService, IPatronRepository patronRepository, JsonLoanRepository loanRepository, JsonData jsonData)
    {
